...
{	
	...
	img[0].src = "static/game/Image/Start/맵.jpg";			// 메인 화면 이미지
	img[1].src = img[0].src;					// 같은 메인 화면 이미지
	img[2].src = "static/game/Image/Start/캐릭터/기본.png"; // 기본 캐릭터
	img[3].src = "static/game/Image/Start/캐릭터/왼캐릭터.png";
	img[4].src = "static/game/Image/Start/캐릭터/기본.png"; // 캐릭터 정면
	img[5].src = "static/game/Image/Start/캐릭터/업.png"; //   캐릭터 위
	img[6].src = "static/game/Image/Start/캐릭터/다운.png"; // 캐릭터 아래
	img[7].src = "static/game/Image/Start/운석/기본.png";
	img[8].src = "static/game/Image/Start/운석/메테오.png";
	img[9].src = "static/game/Image/Start/운석/얼음.png";
	img[10].src = "static/game/Image/Start/운석/요상한.png";
	img[11].src = "static/game/Image/Start/운석/클립토나이트.png ";
	img[12].src = "static/game/Image/Start/총알/유저.png";
	img[UserEffect.SpriteImage].src = "static/game/Image/Start/이펙트/유저 부스터.png";
	img[14].src = "static/game/Image/Start/이펙트/운석 폭발.png";
